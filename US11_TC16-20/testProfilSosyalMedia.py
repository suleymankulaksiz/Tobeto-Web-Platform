...
class Test_Chatbox: 
    ...
    def test_valid_login(self, username, password):
        ...
        profilButton.click().send_keys(Keys.ARROW_DOWN).send_keys(Keys.ENTER)
    ...
    def test_tc16(self): #sosyal medya hesabi ekleme testi
        ...
        secinizButton.click().send_keys(Keys.ARROW_DOWN,Keys.ARROW_DOWN,Keys.ARROW_DOWN,Keys.ENTER)
        ...
        secinizButton.click().send_keys(Keys.ARROW_DOWN,Keys.ENTER)
        sosyalMediaUrlBox.send_keys(instagram)
        kaydetButton.click()
        secinizButton.click().send_keys(Keys.ARROW_DOWN,Keys.ARROW_DOWN,Keys.ENTER)
        ...
        assert sMedyaBasariliEklendiMsj_css.is_displayed,"sosyal medya başariyla eklendi msji görüntülenmedi!!"
        deleteIkon.click()
    ...
    def test_tc17(self): #ayni hesabi yeniden ekleme
        ...
        assert buHesapKayitliUyarisi_css.is_displayed(),"bu sosyal medya zaten mevcut uyarisi gorulmedi!! "

        #tc18-20 fail  ttc 19 kaldi
