...
class Test_Languages:
    ...
    def setup(self):
        ...
        loginBtn.click()
        sleep(5)
        right_name_dropdown=self.waitForElementVisible((By.XPATH, RIGHT_NAME_DROPDOWN_XPATH))
        right_name_dropdown.click()
        dropdown_profile_info=self.waitForElementVisible((By.CLASS_NAME, DROPDOWN_PROFILE_INFO_CLASS_NAME))
    ...
    def select_german(self):
        ...
        selection_german=self.waitForElementVisible((By.XPATH, OPTION_GERMAN_XPATH))
        selection_german.click()
        select_level=self.waitForElementVisible((By.XPATH, SELECT_LEVEL_XPATH))
        select_level.click()
        add_basic_level=self.waitForElementVisible((By.XPATH, BASIC_LEVEL_XPATH))
    ...
    def test_my_languages(self):
        ...
        sleep(2)
        select_the_language_dropdown.click()
        selection_cekce=self.waitForElementVisible((By.XPATH, OPTION_CEKCE_XPATH))
        ...
        sleep(2)
        select_the_language_dropdown.click()
        selection_cince=self.waitForElementVisible((By.XPATH, OPTION_CHINESE_XPATH))
        ...
        save_button=self.waitForElementVisible((By.XPATH, SAVE_BUTTON_XPATH))
        save_button.click()
        langs_section = self.driver.find_element(By.XPATH, LANS_SECTION_XPATH)
        sleep(2)
        lang_edit_elements = langs_section.find_elements(By.XPATH, LANG_EDIT_ELEMENT_XPATH)
    ...
    def test_required_field(self): 
        save_button=self.waitForElementVisible((By.XPATH, SAVE_BUTTON_XPATH))
        save_button.click()
        language_required_field=self.waitForElementVisible((By.XPATH, LANGUAGE_REQUIRED_FIELD_XPATH))
        level_required_field=self.waitForElementVisible((By.XPATH, LEVEL_REQUIRED_FIELD_XPATH))
        assert language_required_field, level_required_field== REQUIRED_FIELD_TEXT
    ...
    def test_added_same_language(self): #DONE
        ...
        assert already_added.text==ALREADY_EXISTS_LANGUAGE_TEXT
    ...
    def test_my_foreign_language(self): #Yukarıdakileri tek def içinde denedim
        ...
        answer_yes.click()
        successful_message=self.waitForElementVisible((By.XPATH, REMOVED_MESSAGE_XPATH))
        assert {language_required_field, level_required_field== REQUIRED_FIELD_TEXT and
                added.text==ADDED_LANGUAGE_TEXT and 
                already_added.text==ALREADY_EXISTS_LANGUAGE_TEXT and
