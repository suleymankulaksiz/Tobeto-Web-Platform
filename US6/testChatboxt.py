...
class Test_Chatbox: 
    ...
    def test_tc01(self): #msj kutusunu kücültme ıkonun testi
        ...
        kucultmeIkon.click()
        assert not self.msjIkon.is_displayed(), "Mesaj kutusu hala acik"
    ...
    def test_tc03(self): #emojilerin testi
        ...
        elEmojisi.click().send_keys(Keys.ARROW_DOWN).send_keys(Keys.ARROW_DOWN).send_keys(Keys.ENTER)  #orta-acık el rengi secildi
    ...
    def test_tc06(self): #Gorusmeyi sonlandırma
        ...
        hayirButton.click()
        gorusmeyiSonlandirIkon=self.waitForElementVisible((By.CSS_SELECTOR,gorusmeyiSonlandirIkon_css)).click()
